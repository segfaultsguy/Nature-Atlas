...
/**
 * Created by Brandan on 3/24/2016.
 */
public class CheckRetriever
{

    private JSONArray dateJSON;

    public CheckRetriever( Context context) {
        ...
        String connect = "http://natureatlas.org/appServices/checkDictionary.php";
