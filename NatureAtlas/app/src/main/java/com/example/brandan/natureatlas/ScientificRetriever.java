 ...
 */
public class ScientificRetriever extends AsyncTask<Void, Void, JSONArray>
{
    public ScientificRetriever(CallBack callBack)
    {
    ...
    protected JSONArray doInBackground(Void...params)
    {
        ...
        String connect = "http://natureatlas.org/appServices/getDictionary.php";
    ...
    private ScientificRetriever.CallBack callBack;
